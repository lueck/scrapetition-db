...
GRANT SELECT ON TABLE scrapetition.article_tag
TO scraper;
...
CREATE TRIGGER evaluate_tag_on_insert BEFORE INSERT ON scrapetition.article_tag
    FOR EACH ROW EXECUTE PROCEDURE scrapetition.evaluate_tag();

CREATE TRIGGER evaluate_tag_on_update BEFORE UPDATE ON scrapetition.article_tag
    FOR EACH ROW EXECUTE PROCEDURE scrapetition.evaluate_tag();
